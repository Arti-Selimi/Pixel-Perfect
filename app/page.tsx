...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-start gap-5 py-10 bg-[#111827] text-green-600 w-full h-full font-extrabold">
      <ClickSound />
      <ColorBox />
      ...
      <div className="w-full p-5">
        <h1 className="text-3xl pb-5 underline">
          About Me
        </h1>
        <Main />
      </div>
